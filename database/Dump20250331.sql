...
CREATE TABLE `user` (
  ...
  CONSTRAINT `FK_User` FOREIGN KEY (`IdRole`) REFERENCES `role` (`IdRole`)
...
INSERT INTO `user` VALUES (1,'Admin','Admin','00000000','admin@diabecheck.com','2001-09-27','0.png',1,1,'2024-08-22 20:39:38','2024-08-22 20:39:38'),(2,'Paciente','Uno','0000001','paciente01@gmail.com','1991-08-14','0.png',2,1,'2024-08-22 20:46:01','2024-08-22 20:46:01'),(3,'Doctor','Uno','0000002','Medico01@gmail.com','1982-05-09','0.png',3,1,'2024-08-22 20:46:25','2024-08-22 20:46:25'),(4,'Paciente','Dos','0000003','Paciente02@gmail.com','1998-05-14','2.png',2,1,'2024-09-03 21:24:49','2024-09-03 21:24:49'),(5,'Doctor','Dos','0000004','Medico02@gmail.com','1993-04-28','0.png',3,1,'2024-09-03 21:24:49','2024-09-03 21:24:49'),(6,'Paciente','Tres','0000005','Paciente03@gmail.com','1974-06-03','0.png',2,1,'2024-09-03 21:24:49','2024-09-03 21:24:49'),(7,'Paciente ','Cuatro','0000006','paciente04@gmail.com','2002-12-16','0.png',2,1,'2024-09-03 21:24:49','2024-09-03 21:24:49'),(8,'Paciente','Cinco','0000007','paciente05@gmail.com','1986-10-15','0.png',2,1,'2024-09-03 21:24:49','2024-09-03 21:24:49'),(9,'Doctor','Tres','0000008','Medico03@gmail.com','1971-02-14','0.png',3,1,'2024-09-03 21:24:49','2024-09-03 21:24:49');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetPatientFiles`(paciente_id INT)
SELECT a.IdFile, a.Name, a.FilePath, a.PublishDate, u.LastName CreatorLastName, u.Name CreatorName
    ...
    WHERE IdPatient = paciente_id AND a.Active = 1
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetPatientMeasures` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetPatientMeasures`(idPatient INT, month INT, year INT)
BEGIN
	SELECT m.*, u.Name, u.LastName
    FROM PatientMeasure AS m
    INNER JOIN User AS u ON m.IdPatient = u.IdUser
    WHERE MONTH(m.MeasureDate) = month AND YEAR(m.MeasureDate) = year AND IdPatient = idPatient AND m.Active = 1
    ORDER BY m.MeasureDate ASC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-03-31 18:52:22
